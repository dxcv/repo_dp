...
def cuadro_moneda_final(cuadro_resumen_forwards, cuadro_resumen_físico_extranjero, cuadro_resumen_fisico_local, date):
	...
	cuadro_moneda_final = pd.concat([cuadro_resumen_forwards[["Moneda","Porcentaje","Fecha"]],cuadro_resumen_físico_extranjero[["Moneda","Porcentaje","Fecha"]][:-1],cuadro_resumen_fisico_local])
...
def delete_old_data(tabla):
    ...
    delete_statement = "DELETE FROM tabla WHERE 1=1"
...
def upload_cuadro_2(cuadro_2):
    ...
    '''
    delete_old_data("ZHIS_AFP_cuadro_2")
...
def upload_cuadro_3(cuadro_3):
    ...
    '''
    #delete_old_data(ZHIS_AFP_cuadro_3)
...
path = "cartera_agregada201711.xml"
y = read_file(path)
