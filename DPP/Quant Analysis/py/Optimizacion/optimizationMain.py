# -*- coding: utf-8 -*-
"""
Created on Thu Feb 09 16:05:12 2017
...
## Analisis Fondos
    p = pd.read_excel('L:\\Rates & FX\\Quant Analysis\\py\\Optimizacion\\spmac.xlsx', sheetname='precio', headers=1, index_col=0)
    names = pd.read_excel('L:\\Rates & FX\\Quant Analysis\\py\\Optimizacion\\spmac.xlsx', sheetname='Classif', headers=0)
    rA = resampledAllocation()
    s = p.columns
    mu, omega = rA.computeAssetsMeanVariance(p)
    pr, pv, pw = rA.portfolioOptimization(mu,omega)
